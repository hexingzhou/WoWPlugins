-- PLAYER_ENTERING_WORLD PLAYER_REGEN_ENABLED PLAYER_REGEN_DISABLED PLAYER_TARGET_CHANGED PLAYER_ALIVE PLAYER_DEAD PLAYER_UNGHOST BARBER_SHOP_OPEN BARBER_SHOP_CLOSE OPTIONS PLAYER_MOUNT_DISPLAY_CHANGED UPDATE_BONUS_ACTIONBAR HWA_UPDATE_SHAPESHIFT_FORM STATUS HWA_INIT HWA_ALPHA
